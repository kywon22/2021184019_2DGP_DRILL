...
#이벤트 정의
RD, LD, RU, LU, AT, UT, TIMER = range(7)
...
next_state = {
    ...
    IDLE: {RU: RUN, LU: RUN, RD: RUN, LD: RUN, TIMER: SLEEP, AT: AUTO_RUN},
    RUN: {RU: IDLE, LU: IDLE, LD: IDLE, RD: IDLE, TIMER: RUN, AT: AUTO_RUN},
    AUTO_RUN: {AT: IDLE, RU: RUN, LU: RUN, RD: RUN, LD: RUN}
}
